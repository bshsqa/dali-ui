...
public:
   ...
   *
   * This is equivalent to calling SetAccessibilityState(state, true).
   *
   * @SINCE_2_5.30
   * @param[in] state The accessibility state to enable
   * @see Dali::Ui::Accessibility::State
   * @see SetAccessibilityState()
   */
   ...
   *
   * This is equivalent to calling SetAccessibilityState(state, false).
   *
   * @SINCE_2_5.30
  ...
  /**
   * @brief Sets or clears the given accessibility state on this View.
   *
   * @SINCE_2_5.30
   * @param[in] state The accessibility state to update
   * @param[in] enabled True to add the state, false to remove it
   * @see Dali::Ui::Accessibility::State
   */
  void SetAccessibilityState(Accessibility::State state, bool enabled);
