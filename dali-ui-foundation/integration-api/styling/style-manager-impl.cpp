...
void StyleManager::OnAdaptorInit()
{
  if(Dali::Adaptor::IsAvailable())
  {
    ...
    if(mInitializedControlsBeforeAdaptorInit.size() > 0)
    {
      ...
      {
        UI::View controlHandle = weakControl.GetHandle();
        if(controlHandle)
        {
...
void StyleManager::ApplyThemeStyle(UI::View control)
{
...
void StyleManager::ApplyThemeStyleAtInit(UI::View control)
{
  // If the adaptor is not initialized yet, we will style the control later
  if(!mAdaptorInitialized)
  {
...
void StyleManager::ApplyStyle(UI::View control, const std::string& jsonFileName, const std::string& styleName)
{
...
static bool GetStyleNameForControl(UI::Builder builder, UI::View control, std::string& styleName)
{
...
void StyleManager::ApplyStyle(UI::Builder builder, UI::View control)
{
...
const StylePtr StyleManager::GetRecordedStyle(UI::View control)
{
  if(mThemeBuilder)
  {
    std::string styleName = control.GetStyleName();
