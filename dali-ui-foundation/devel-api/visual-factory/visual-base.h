 ...
 * Dali::Toolkit::VisualFactory::CreateVisual().
 *
 * | %Property Name          | Type             |
 * |-------------------------|------------------|
 * | customShader            | MAP              |
 ...
 * or STRING | No       | CENTER                 | origin of the visual @sa Dali::Toolkit::Align       | | anchorPoint
 * | INTEGER or STRING | No       | CENTER                 | anchor point of the visual @sa Dali::Toolkit::Align | |
 * offsetPolicy            | VECTOR2           | No       | ( RELATIVE, RELATIVE ) | @sa
 * Dali::Toolkit::Visual::Transform::Policy   | | sizePolicy              | VECTOR2           | No       | ( RELATIVE,
 * RELATIVE ) | @sa Dali::Toolkit::Visual::Transform::Policy   |
 *
