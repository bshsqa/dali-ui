...
// TODO: These dali-toolkit includes should be replaced when the code is migrated
...
{
  std::string focusBorderImagePath(Toolkit::AssetManager::GetDaliImagePath());
  focusBorderImagePath += "/keyboard_focus.9.png";

  auto actor = Toolkit::ImageView::New(focusBorderImagePath);
  actor.SetResizePolicy(ResizePolicy::FILL_TO_PARENT, Dimension::ALL_DIMENSIONS);

  UI::DevelControl::AppendAccessibilityAttribute(UI::Control::DownCast(actor), "highlight", std::string());
...
{
  auto control = UI::Control::DownCast(Self());
...
Dali::Accessibility::Attributes ControlAccessible::GetAttributes() const
{
  ...
  // TODO: ImageView image source attribute will be handled after ImageView migration
