...
// TODO: accessibility-highlight-overlay is still in dali-toolkit, keep reference for now
...
public:
  ...
  /**
   * @brief Makes sure that a given child (descendant) of this container is visible
...
private:
  ...
  Dali::Toolkit::DevelControl::AccessibilityHighlightOverlay mHighlightOverlay;
};
