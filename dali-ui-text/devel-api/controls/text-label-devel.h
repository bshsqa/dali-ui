...
enum Type
{
   ...
   * @details Name "textDirection", type [Type](@ref Dali::UI::DevelText::TextDirection::Type) (Property::INTEGER), Read/Write
   ...
   * @details Name "verticalLineAlignment", type [Type](@ref Dali::UI::DevelText::VerticalLineAlignment::Type) (Property::INTEGER), Read/Write
   ...
   * @details Name "EllipsisPosition", type [Type](@ref Dali::UI::DevelText::EllipsisPosition::Type) (Property::INTEGER), or Property::STRING. Read/Write
