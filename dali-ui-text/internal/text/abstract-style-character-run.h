...
// INTERNAL INCLUDES
#include <dali-ui-text/internal/text/character-run.h>
...
template<>
struct TypeTraits<Dali::UI::Text::AbstractStyleCharacterRun> : public Dali::BasicTypes<Dali::UI::Text::AbstractStyleCharacterRun>
{
  enum
  {
