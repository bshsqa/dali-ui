...
#include <dali-ui-text/internal/text/strikethrough-style-properties.h>
...
template<>
struct TypeTraits<Dali::UI::Text::StrikethroughCharacterRun> : public Dali::BasicTypes<Dali::UI::Text::StrikethroughCharacterRun>
{
  enum
  {
