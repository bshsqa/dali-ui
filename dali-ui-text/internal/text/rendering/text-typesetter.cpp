...
#include <dali-ui-text/internal/text/line-helper-functions.h>
#include <dali-ui-text/internal/text/rendering/styles/character-spacing-helper-functions.h>
#include <dali-ui-text/internal/text/rendering/styles/strikethrough-helper-functions.h>
#include <dali-ui-text/internal/text/rendering/styles/underline-helper-functions.h>
#include <dali-ui-text/internal/text/rendering/text-typesetter-impl.h>
#include <dali-ui-text/internal/text/rendering/view-model.h>
...
PixelData Typesetter::Render(const Vector2& size, UI::DevelText::TextDirection::Type textDirection, RenderBehaviour behaviour, bool ignoreHorizontalAlignment, Pixel::Format pixelFormat, const Vector2& originSize)
{
...
PixelData Typesetter::RenderWithCutout(const Vector2& size, UI::DevelText::TextDirection::Type textDirection, Devel::PixelBuffer mask, RenderBehaviour behaviour, bool ignoreHorizontalAlignment, Pixel::Format pixelFormat, float originAlpha, const Vector2& originSize)
{
  Devel::PixelBuffer result = RenderWithPixelBuffer(size, textDirection, behaviour, ignoreHorizontalAlignment, pixelFormat, originSize);
...
Devel::PixelBuffer Typesetter::RenderWithPixelBuffer(const Vector2& size, UI::DevelText::TextDirection::Type textDirection, RenderBehaviour behaviour, bool ignoreHorizontalAlignment, Pixel::Format pixelFormat, const Vector2& originSize)
{
