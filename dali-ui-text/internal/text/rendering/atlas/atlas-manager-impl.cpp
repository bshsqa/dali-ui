...
// CLASS HEADER
#include <dali-ui-text/internal/text/rendering/atlas/atlas-manager-impl.h>
...
bool AtlasManager::Add(const PixelData&                  image,
                       UI::AtlasManager::AtlasSlot& slot,
                       UI::AtlasManager::AtlasId    atlas)
{
  bool          created     = false;
...
void AtlasManager::GenerateMeshData(ImageId                        id,
                                    ...
                                    UI::AtlasManager::Mesh2D& meshData,
                                    bool                           addReference)
{
  if(id)
  {
