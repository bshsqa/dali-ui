...
// CLASS HEADER
#include <dali-ui-text/internal/text/rendering/atlas/atlas-glyph-manager-impl.h>
...
void AtlasGlyphManager::AdjustReferenceCount(Text::FontId fontId, Text::GlyphIndex index, const UI::AtlasGlyphManager::GlyphStyle& style, int32_t delta)
{
  if(0 != delta)
  {
