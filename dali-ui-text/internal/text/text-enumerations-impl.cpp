...
bool GetHorizontalAlignmentEnumeration(const Property::Value& propertyValue, UI::Text::HorizontalAlignment::Type& alignment)
{
...
{
  return Scripting::GetLinearEnumerationName<UI::Text::HorizontalAlignment::Type>(alignment,
...
{
  return Scripting::GetLinearEnumerationName<UI::Text::VerticalAlignment::Type>(alignment,
                                                                                     VERTICAL_ALIGNMENT_TYPE_TABLE,
                                                                                     VERTICAL_ALIGNMENT_TYPE_TABLE_COUNT);
}

bool GetEllipsisPositionTypeEnumeration(const Property::Value& propertyValue, UI::DevelText::EllipsisPosition::Type& ellipsisPositionType)
{
...
{
  return Scripting::GetLinearEnumerationName<UI::Text::Underline::Type>(type,
