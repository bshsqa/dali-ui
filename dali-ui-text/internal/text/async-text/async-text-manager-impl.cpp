...
// CLASS HEADER
#include <dali-ui-text/internal/text/async-text/async-text-manager-impl.h>
...
Dali::UI::Text::Internal::AsyncTextManager* gAsyncTextManager = nullptr;  ///< Must be used under gStaticAsyncTextManagerMutex
} // namespace
...
uint32_t AsyncTextManager::RequestLoad(AsyncTextParameters& parameters, TextLoadObserver* observer)
{
  ...
  auto task = new Dali::UI::Internal::TextLoadingTask(mTaskId, parameters, MakeCallback(this, &AsyncTextManager::LoadComplete));
