...
// CLASS HEADER
#include <dali-ui-text/internal/text/async-text/text-loading-task.h>
...
// INTERNAL INCLUDES
#include <dali-ui-text/internal/text/async-text/async-text-manager-impl.h> ///< To call AsyncTextManager::ReleaseLoader
