...
// CLASS  HEADER
#include <dali-ui-text/internal/text/async-text/async-text-loader-impl.h>
...
#include <dali-ui-text/internal/text/color-segmentation.h>
#include <dali-ui-text/internal/text/hyphenator.h>
#include <dali-ui-text/internal/text/markup-processor/markup-processor.h>
#include <dali-ui-text/internal/text/segmentation.h>
#include <dali-ui-text/internal/text/shaper.h>
...
AsyncTextRenderInfo AsyncTextLoader::Render(AsyncTextParameters& parameters)
{
  ...
  UI::DevelText::TextDirection::Type textDirection = mIsTextDirectionRTL ? UI::DevelText::TextDirection::RIGHT_TO_LEFT : UI::DevelText::TextDirection::LEFT_TO_RIGHT;
