...
#include <dali-ui-text/internal/text/underline-style-properties.h>
...
template<>
struct TypeTraits<Dali::UI::Text::UnderlinedCharacterRun> : public Dali::BasicTypes<Dali::UI::Text::UnderlinedCharacterRun>
{
  enum
  {
