...
#include <dali-ui-text/internal/text/controller/text-controller-background-actor.h>
#include <dali-ui-text/internal/text/controller/text-controller-event-handler.h>
#include <dali-ui-text/internal/text/controller/text-controller-impl.h>
#include <dali-ui-text/internal/text/controller/text-controller-input-font-handler.h>
#include <dali-ui-text/internal/text/controller/text-controller-input-properties.h>
...
#include <dali-ui-text/internal/text/controller/text-controller-spannable-handler.h>
#include <dali-ui-text/internal/text/controller/text-controller-text-updater.h>
#include <dali-ui-text/internal/text/text-editable-control-interface.h>
#include <dali-ui-text/internal/text/text-geometry.h>
