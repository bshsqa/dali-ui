...
// CLASS HEADER
#include <dali-ui-text/internal/text/controller/text-controller-impl.h>
...
#include <dali-ui-text/internal/text/controller/text-controller-impl-data-clearer.h>
#include <dali-ui-text/internal/text/controller/text-controller-impl-event-handler.h>
#include <dali-ui-text/internal/text/controller/text-controller-impl-model-updater.h>
#include <dali-ui-text/internal/text/controller/text-controller-placeholder-handler.h>
#include <dali-ui-text/internal/text/controller/text-controller-relayouter.h>
...
#include <dali-ui-text/internal/text/text-run-container.h>
#include <dali-ui-text/internal/text/text-selection-handle-controller.h>
...
UI::DevelText::TextDirection::Type Controller::Impl::GetTextDirection()
{
  ...
  return mIsTextDirectionRTL ? UI::DevelText::TextDirection::RIGHT_TO_LEFT : UI::DevelText::TextDirection::LEFT_TO_RIGHT;
}
...
bool Controller::Impl::ShouldClearFocusOnEscape() const
{
  if(DALI_UNLIKELY(mShouldClearFocusOnEscape == ClearFocusOnEscapeState::UNKNOWN))
  {
    ...
    if(styleManager)
    {
      const auto clearFocusOnEscapeValue = UI::DevelStyleManager::GetConfigurations(styleManager).Find("clearFocusOnEscape", Property::Type::BOOLEAN);
