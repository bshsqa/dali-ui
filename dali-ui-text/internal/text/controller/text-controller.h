...
#include <dali-ui-text/internal/text/input-filter.h>
...
private:
   ...
   *
   * If there are notifications of change of input style on the queue, UI::TextField::InputStyleChangedSignal() are emitted.
   */
  void OnIdleSignal();
