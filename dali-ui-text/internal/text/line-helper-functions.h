 ...
 */
float GetPreOffsetVerticalLineAlignment(const LineRun& line, const Dali::UI::DevelText::VerticalLineAlignment::Type& verLineAlign);
 ...
 */
float GetPostOffsetVerticalLineAlignment(const LineRun& line, const Dali::UI::DevelText::VerticalLineAlignment::Type& verLineAlign);
} // namespace Text
