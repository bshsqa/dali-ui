...
// INTERNAL INCLUDES
#include <dali-ui-text/internal/text/anchor.h>
#include <dali-ui-text/internal/text/bidirectional-line-info-run.h>
#include <dali-ui-text/internal/text/bidirectional-paragraph-info-run.h>
#include <dali-ui-text/internal/text/bidirectional-support.h>
#include <dali-ui-text/internal/text/bounded-paragraph-run.h>
#include <dali-ui-text/internal/text/character-spacing-character-run.h>
#include <dali-ui-text/internal/text/color-run.h>
#include <dali-ui-text/internal/text/embedded-item.h>
#include <dali-ui-text/internal/text/font-description-run.h>
#include <dali-ui-text/internal/text/font-run.h>
#include <dali-ui-text/internal/text/paragraph-run.h>
#include <dali-ui-text/internal/text/script-run.h>
#include <dali-ui-text/internal/text/strikethrough-character-run.h>
#include <dali-ui-text/internal/text/underlined-character-run.h>
