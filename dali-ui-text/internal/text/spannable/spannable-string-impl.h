...
// EXTERNAL INCLUDES
#include <dali-ui-text/devel-api/text/spannable-string.h>
#include <memory>

// INTERNAL INCLUDES
#include <dali-ui-text/internal/text/spannable/span-ranges-container-impl.h>
#include <dali-ui-text/internal/text/spannable/spannable-impl.h>
...
public:
   ...
   */
  void RetrieveAllSpansAndRanges(std::vector<Dali::UI::Text::BaseSpan>& spans, std::vector<Dali::UI::Text::Range>& ranges) const;
