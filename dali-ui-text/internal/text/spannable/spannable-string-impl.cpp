...
// CLASS HEADER
#include <dali-ui-text/internal/text/spannable/spannable-string-impl.h>
...
void SpannableString::RetrieveAllSpansAndRanges(std::vector<Dali::UI::Text::BaseSpan>& spans, std::vector<Dali::UI::Text::Range>& ranges) const
{
