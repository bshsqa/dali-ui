...
// CLASS HEADER
#include <dali-ui-text/internal/text/spannable/spans/underline-span-impl.h>
...
void UnderlineSpan::CreateStyleCharacterRun(IntrusivePtr<LogicalModel>& logicalModel, const Dali::UI::Text::Range& range) const
{
