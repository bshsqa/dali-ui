...
// EXTERNAL INCLUDES
#include <dali-ui-text/devel-api/text/spans/character-spacing-span.h>
#include <memory>

// INTERNAL INCLUDES
#include <dali-ui-text/internal/text/logical-model-impl.h>
#include <dali-ui-text/internal/text/spannable/spans/base-span-impl.h>
...
public: //Methods for internal only
   ...
   */
  void CreateStyleCharacterRun(IntrusivePtr<LogicalModel>& logicalModel, const Dali::UI::Text::Range& range) const override;
...
inline const Internal::CharacterSpacingSpan& GetImplementation(const Dali::UI::Text::CharacterSpacingSpan& CharacterSpacingSpan)
{
  DALI_ASSERT_ALWAYS(CharacterSpacingSpan && "CharacterSpacingSpan handle is empty");
