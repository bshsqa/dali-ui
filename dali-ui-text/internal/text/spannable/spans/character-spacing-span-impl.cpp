...
// CLASS HEADER
#include <dali-ui-text/internal/text/spannable/spans/character-spacing-span-impl.h>
...
void CharacterSpacingSpan::CreateStyleCharacterRun(IntrusivePtr<LogicalModel>& logicalModel, const Dali::UI::Text::Range& range) const
{
