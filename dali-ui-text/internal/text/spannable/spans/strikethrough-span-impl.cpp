...
// CLASS HEADER
#include <dali-ui-text/internal/text/spannable/spans/strikethrough-span-impl.h>
...
void StrikethroughSpan::CreateStyleCharacterRun(IntrusivePtr<LogicalModel>& logicalModel, const Dali::UI::Text::Range& range) const
