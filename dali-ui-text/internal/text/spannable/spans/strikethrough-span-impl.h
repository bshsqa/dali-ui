...
// EXTERNAL INCLUDES
#include <dali-ui-text/devel-api/text/spans/strikethrough-span.h>
#include <memory>
...
inline const Internal::StrikethroughSpan& GetImplementation(const Dali::UI::Text::StrikethroughSpan& foregroundColorSpan)
{
  DALI_ASSERT_ALWAYS(foregroundColorSpan && "foregroundColorSpan handle is empty");
