...
// CLASS HEADER
#include <dali-ui-text/internal/text/spannable/spans/bold-span-impl.h>
...
void BoldSpan::CreateStyleCharacterRun(IntrusivePtr<LogicalModel>& logicalModel, const Dali::UI::Text::Range& range) const
{
