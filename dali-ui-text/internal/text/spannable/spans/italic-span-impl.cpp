...
// CLASS HEADER
#include <dali-ui-text/internal/text/spannable/spans/italic-span-impl.h>
...
void ItalicSpan::CreateStyleCharacterRun(IntrusivePtr<LogicalModel>& logicalModel, const Dali::UI::Text::Range& range) const
{
