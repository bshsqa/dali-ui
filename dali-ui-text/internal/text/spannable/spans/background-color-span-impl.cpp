...
// CLASS HEADER
#include <dali-ui-text/internal/text/spannable/spans/background-color-span-impl.h>
...
void BackgroundColorSpan::CreateStyleCharacterRun(IntrusivePtr<LogicalModel>& logicalModel, const Dali::UI::Text::Range& range) const
{
