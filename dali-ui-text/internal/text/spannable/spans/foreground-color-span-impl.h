...
// EXTERNAL INCLUDES
#include <dali-ui-text/devel-api/text/spans/foreground-color-span.h>
#include <memory>
...
inline const Internal::ForegroundColorSpan& GetImplementation(const Dali::UI::Text::ForegroundColorSpan& foregroundColorSpan)
{
  DALI_ASSERT_ALWAYS(foregroundColorSpan && "foregroundColorSpan handle is empty");
