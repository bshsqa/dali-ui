...
// CLASS HEADER
#include <dali-ui-text/internal/text/spannable/spans/font-span-impl.h>

// EXTERNAL INCLUDES
#include <dali-ui-text/devel-api/text/spans/font-span.h>
#include <memory.h>
...
Dali::UI::Text::FontSpan FontSpan::New(const std::string&                             familyName,
...
void FontSpan::CreateStyleCharacterRun(IntrusivePtr<LogicalModel>& logicalModel, const Dali::UI::Text::Range& range) const
{
