...
// EXTERNAL INCLUDES
#include <dali-ui-text/devel-api/text/spans/background-color-span.h>
#include <memory>
...
inline const Internal::BackgroundColorSpan& GetImplementation(const Dali::UI::Text::BackgroundColorSpan& BackgroundColorSpan)
{
  DALI_ASSERT_ALWAYS(BackgroundColorSpan && "BackgroundColorSpan handle is empty");
