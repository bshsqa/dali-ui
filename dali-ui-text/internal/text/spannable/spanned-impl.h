...
// INTERNAL INCLUDES
#include <dali-ui-text/internal/text/string-text/character-sequence-impl.h>
...
public: //Methods
   ...
   */
  virtual void RetrieveAllSpansAndRanges(std::vector<Dali::UI::Text::BaseSpan>& spans, std::vector<Dali::UI::Text::Range>& ranges) const = 0;
