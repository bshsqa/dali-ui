...
// EXTERNAL INCLUDES
#include <dali-ui-text/devel-api/text/range.h>
#include <dali-ui-text/devel-api/text/spans/base-span.h>
...
#include <dali-ui-text/internal/text/string-text/range-impl.h>
...
public:
   ...
   */
  void GetSpansAndRanges(std::vector<Dali::UI::Text::BaseSpan>& spans, std::vector<Dali::UI::Text::Range>& ranges) const;
