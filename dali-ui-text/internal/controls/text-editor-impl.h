...
#include <dali-ui-text/internal/text/rendering/text-renderer.h>
...
private: // Implementation
   ...
   *
   * If there are notifications of change of input style on the queue, UI::TextEditor::InputStyleChangedSignal() are emitted.
   */
  void OnIdleSignal();
...
private: // Data
  ...
  public:
    ...
    /**
     * @copydoc Dali::UI::DevelView::ControlAccessible::GetNameRaw()
     */
