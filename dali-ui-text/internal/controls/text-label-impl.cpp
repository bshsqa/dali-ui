...
// CLASS HEADER
#include <dali-ui-text/internal/controls/text-label-impl.h>
  ...
  if(label)
  {
    ...
    switch(index)
    {
      ...
      case UI::TextLabel::Property::AUTO_SCROLL_STOP_MODE:
      {
        ...
        if(Scripting::GetEnumerationProperty<UI::TextLabel::AutoScrollStopMode::Type>(value,
  ...
  if(label)
  {
    ...
    switch(index)
    {
      ...
      case UI::TextLabel::Property::AUTO_SCROLL_STOP_MODE:
      {
        if(impl.mTextScroller)
        {
          const char* mode = Scripting::GetEnumerationName<UI::TextLabel::AutoScrollStopMode::Type>(impl.mTextScroller->GetStopMode(),
                                                                                                         AUTO_SCROLL_STOP_MODE_TABLE,
                                                                                                         AUTO_SCROLL_STOP_MODE_TABLE_COUNT);
          if(mode)
          {
...
void TextLabel::SetMaskEffect(UI::View control)
{
  RemoveMaskEffect();

  Actor            self        = Self();
  UI::View selfControl = UI::View::DownCast(self);
...
void TextLabel::RemoveMaskEffect()
{
  ...
  UI::View control = mMaskControl.GetHandle();
  if(control)
  {
    self.Remove(control);
  }
