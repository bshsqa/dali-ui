...
// CLASS HEADER
#include <dali-ui-text/internal/controls/text-anchor-impl.h>
...
bool TextAnchor::OnAccessibilityActivated()
{
  ...
  DALI_LOG_ERROR("TextAnchor::OnAccessibilityActivate cannot find ancestor actor implementing Dali::UI::Text::AnchorControlInterface.\n");
  return false;
}
