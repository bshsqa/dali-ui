...
void TextField::PropertyHandler::SetProperty(UI::TextField textField, Property::Index index, const Property::Value& value)
{
  ...
  switch(index)
  {
    ...
    case UI::TextField::Property::SELECTION_HANDLE_MARKER_IMAGE_LEFT:
    {
      ...
      if(filename.size())
      {
        impl.mDecorator->SetHandleImage(UI::Text::LEFT_SELECTION_HANDLE_MARKER,
                                        UI::Text::HANDLE_IMAGE_RELEASED,
                                        filename);
        impl.RequestTextRelayout();
      }
      break;
    ...
    case UI::TextField::Property::SELECTION_HANDLE_MARKER_IMAGE_RIGHT:
    {
      ...
      if(filename.size())
      {
        impl.mDecorator->SetHandleImage(UI::Text::RIGHT_SELECTION_HANDLE_MARKER,
                                        UI::Text::HANDLE_IMAGE_RELEASED,
                                        filename);
        impl.RequestTextRelayout();
      }
    ...
    case UI::TextField::Property::INPUT_METHOD_SETTINGS:
    {
      ...
      UI::View control = UI::KeyInputFocusManager::Get().GetCurrentFocusControl();
