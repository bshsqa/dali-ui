...
// CLASS HEADER
#include <dali-ui-text/internal/controls/text-selection-popup-impl.h>
...
void TextSelectionPopup::GetProperties(Property::Map& properties)
{
  ...
  map.Insert(UI::TextSelectionPopup::Property::OPTION_DIVIDER_PADDING, Vector4(mOptionDividerPadding.left, mOptionDividerPadding.right, mOptionDividerPadding.top, mOptionDividerPadding.bottom));
  map.Insert(UI::TextSelectionPopup::Property::LABEL_MINIMUM_SIZE, mLabelMinimumSize);
  map.Insert(UI::TextSelectionPopup::Property::LABEL_PADDING, Vector4(mLabelPadding.left, mLabelPadding.right, mLabelPadding.top, mLabelPadding.bottom));
...
void TextSelectionPopup::ShowPopup()
{
  if((!mPopupShowing || mButtonsChanged) &&
     (UI::TextSelectionPopup::NONE != mEnabledButtons))
  {
    Actor self = Self();
...
void TextSelectionPopup::OnInitialize()
{
  ...
  // Accessibility
  self.SetProperty(UI::DevelView::Property::ACCESSIBILITY_HIGHLIGHTABLE, true);
  self.SetProperty(UI::DevelView::Property::ACCESSIBILITY_ROLE, Dali::Accessibility::Role::DIALOG);
}
...
void TextSelectionPopup::CreateOrderedListOfPopupOptions()
{
  ...
  mOrderListOfButtons.push_back(ButtonRequirement(UI::TextSelectionPopup::CUT, mCutOptionPriority, OPTION_CUT, POPUP_CUT_STRING, 0 != (mEnabledButtons & UI::TextSelectionPopup::CUT)));
  mOrderListOfButtons.push_back(ButtonRequirement(UI::TextSelectionPopup::COPY, mCopyOptionPriority, OPTION_COPY, POPUP_COPY_STRING, 0 != (mEnabledButtons & UI::TextSelectionPopup::COPY)));
  mOrderListOfButtons.push_back(ButtonRequirement(UI::TextSelectionPopup::PASTE, mPasteOptionPriority, OPTION_PASTE, POPUP_PASTE_STRING, 0 != (mEnabledButtons & UI::TextSelectionPopup::PASTE)));
  mOrderListOfButtons.push_back(ButtonRequirement(UI::TextSelectionPopup::SELECT, mSelectOptionPriority, OPTION_SELECT_WORD, POPUP_SELECT_STRING, 0 != (mEnabledButtons & UI::TextSelectionPopup::SELECT)));
  mOrderListOfButtons.push_back(ButtonRequirement(UI::TextSelectionPopup::SELECT_ALL, mSelectAllOptionPriority, OPTION_SELECT_ALL, POPUP_SELECT_ALL_STRING, 0 != (mEnabledButtons & UI::TextSelectionPopup::SELECT_ALL)));
  mOrderListOfButtons.push_back(ButtonRequirement(UI::TextSelectionPopup::CLIPBOARD, mClipboardOptionPriority, OPTION_CLIPBOARD, POPUP_CLIPBOARD_STRING, 0 != (mEnabledButtons & UI::TextSelectionPopup::CLIPBOARD)));
...
void TextSelectionPopup::AddOption(const ButtonRequirement& button, bool showDivider, bool showIcons, bool showCaption)
{
  ...
  if(mPressedImage.empty())
  {
    ...
    selectedBackgroundValue = Property::Value{{UI::Visual::Property::TYPE, UI::Visual::COLOR},
  ...
  if(showDivider)
  {
    ...
    UI::View divider = UI::Control::New();
...
void TextSelectionPopup::CreateBackgroundBorder(Property::Map& propertyMap)
{
  ...
  if(!propertyMap.Empty())
  {
    ...
    if(visual)
    {
      DevelControl::RegisterVisual(*this, UI::TextSelectionPopup::Property::BACKGROUND_BORDER, visual, DepthIndex::CONTENT);
    }
  }
}
