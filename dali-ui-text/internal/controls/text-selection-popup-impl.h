...
public:
  struct ButtonRequirement
  {
    ...
    ButtonRequirement(UI::TextSelectionPopup::Buttons buttonId,
...
private: // Data
  ...
  Dali::UI::TableView mTableOfButtons; // Actor which holds all the buttons, sensitivity can be set on buttons via this actor
