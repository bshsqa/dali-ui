...
// CLASS HEADER
#include <dali-ui-text/internal/controls/text-editor-impl.h>
...
UI::TextEditor::InputStyle::Mask ConvertInputStyle(Text::InputStyle::Mask inputStyleMask)
{
  ...
  {
    editorInputStyleMask = static_cast<UI::TextEditor::InputStyle::Mask>(editorInputStyleMask | UI::TextEditor::InputStyle::COLOR);
  }
  if(InputStyle::NONE != static_cast<InputStyle::Mask>(inputStyleMask & InputStyle::INPUT_FONT_FAMILY))
  {
    editorInputStyleMask = static_cast<UI::TextEditor::InputStyle::Mask>(editorInputStyleMask | UI::TextEditor::InputStyle::FONT_FAMILY);
  }
  if(InputStyle::NONE != static_cast<InputStyle::Mask>(inputStyleMask & InputStyle::INPUT_POINT_SIZE))
  {
    editorInputStyleMask = static_cast<UI::TextEditor::InputStyle::Mask>(editorInputStyleMask | UI::TextEditor::InputStyle::POINT_SIZE);
  }
  if(InputStyle::NONE != static_cast<InputStyle::Mask>(inputStyleMask & InputStyle::INPUT_FONT_WEIGHT))
  {
    editorInputStyleMask = static_cast<UI::TextEditor::InputStyle::Mask>(editorInputStyleMask | UI::TextEditor::InputStyle::FONT_STYLE);
  }
  ...
  {
    editorInputStyleMask = static_cast<UI::TextEditor::InputStyle::Mask>(editorInputStyleMask | UI::TextEditor::InputStyle::LINE_SPACING);
  }
  if(InputStyle::NONE != static_cast<InputStyle::Mask>(inputStyleMask & InputStyle::INPUT_UNDERLINE))
  {
    editorInputStyleMask = static_cast<UI::TextEditor::InputStyle::Mask>(editorInputStyleMask | UI::TextEditor::InputStyle::UNDERLINE);
  }
  if(InputStyle::NONE != static_cast<InputStyle::Mask>(inputStyleMask & InputStyle::INPUT_SHADOW))
  {
    editorInputStyleMask = static_cast<UI::TextEditor::InputStyle::Mask>(editorInputStyleMask | UI::TextEditor::InputStyle::SHADOW);
  }
  if(InputStyle::NONE != static_cast<InputStyle::Mask>(inputStyleMask & InputStyle::INPUT_EMBOSS))
  {
    editorInputStyleMask = static_cast<UI::TextEditor::InputStyle::Mask>(editorInputStyleMask | UI::TextEditor::InputStyle::EMBOSS);
  }
  if(InputStyle::NONE != static_cast<InputStyle::Mask>(inputStyleMask & InputStyle::INPUT_OUTLINE))
  {
    editorInputStyleMask = static_cast<UI::TextEditor::InputStyle::Mask>(editorInputStyleMask | UI::TextEditor::InputStyle::OUTLINE);
  }
  if(InputStyle::NONE != static_cast<InputStyle::Mask>(inputStyleMask & InputStyle::INPUT_STRIKETHROUGH))
  {
    editorInputStyleMask = static_cast<UI::TextEditor::InputStyle::Mask>(editorInputStyleMask | UI::TextEditor::InputStyle::STRIKETHROUGH);
  }
...
void TextEditor::OnInitialize()
{
  ...
  mStencil.SetProperty(UI::DevelView::Property::ACCESSIBILITY_HIDDEN, true);
...
void TextEditor::UpdateScrollBar()
{
  ...
  if(!mScrollBar)
  {
    ...
    UI::View scrollIndicator = UI::View::DownCast(mScrollBar.GetScrollIndicator());
    if(scrollIndicator)
    {
