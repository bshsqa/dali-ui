...
// CLASS HEADER
#include <dali-ui-text/internal/controls/text-field-impl.h>
...
#include <dali-ui-text/internal/controls/text-field-property-handler.h>
...
UI::TextField::InputStyle::Mask ConvertInputStyle(Text::InputStyle::Mask inputStyleMask)
{
  ...
  {
    fieldInputStyleMask = static_cast<UI::TextField::InputStyle::Mask>(fieldInputStyleMask | UI::TextField::InputStyle::COLOR);
  }
  if(InputStyle::NONE != static_cast<InputStyle::Mask>(inputStyleMask & InputStyle::INPUT_FONT_FAMILY))
  {
    fieldInputStyleMask = static_cast<UI::TextField::InputStyle::Mask>(fieldInputStyleMask | UI::TextField::InputStyle::FONT_FAMILY);
  }
  if(InputStyle::NONE != static_cast<InputStyle::Mask>(inputStyleMask & InputStyle::INPUT_POINT_SIZE))
  {
    fieldInputStyleMask = static_cast<UI::TextField::InputStyle::Mask>(fieldInputStyleMask | UI::TextField::InputStyle::POINT_SIZE);
  }
  if(InputStyle::NONE != static_cast<InputStyle::Mask>(inputStyleMask & InputStyle::INPUT_FONT_WEIGHT))
  {
    fieldInputStyleMask = static_cast<UI::TextField::InputStyle::Mask>(fieldInputStyleMask | UI::TextField::InputStyle::FONT_STYLE);
  }
  ...
  {
    fieldInputStyleMask = static_cast<UI::TextField::InputStyle::Mask>(fieldInputStyleMask | UI::TextField::InputStyle::UNDERLINE);
  }
  if(InputStyle::NONE != static_cast<InputStyle::Mask>(inputStyleMask & InputStyle::INPUT_SHADOW))
  {
    fieldInputStyleMask = static_cast<UI::TextField::InputStyle::Mask>(fieldInputStyleMask | UI::TextField::InputStyle::SHADOW);
  }
  if(InputStyle::NONE != static_cast<InputStyle::Mask>(inputStyleMask & InputStyle::INPUT_EMBOSS))
  {
    fieldInputStyleMask = static_cast<UI::TextField::InputStyle::Mask>(fieldInputStyleMask | UI::TextField::InputStyle::EMBOSS);
  }
  if(InputStyle::NONE != static_cast<InputStyle::Mask>(inputStyleMask & InputStyle::INPUT_OUTLINE))
  {
    fieldInputStyleMask = static_cast<UI::TextField::InputStyle::Mask>(fieldInputStyleMask | UI::TextField::InputStyle::OUTLINE);
  }
