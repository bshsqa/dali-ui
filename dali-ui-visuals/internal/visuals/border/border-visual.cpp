...
#include <dali-ui-visuals/public-api/visuals/border-visual-properties.h>
...
void BorderVisual::DoSetOnScene(Actor& actor)
{
  ...
  {
    mBorderColorIndex = mImpl->mRenderer.RegisterUniqueProperty(UI::BorderVisual::Property::COLOR, COLOR_NAME, mBorderColor);
  }
  ...
  {
    mBorderSizeIndex = mImpl->mRenderer.RegisterUniqueProperty(UI::BorderVisual::Property::SIZE, SIZE_NAME, mBorderSize);
  }
