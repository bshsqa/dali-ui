...
SvgVisual::~SvgVisual()
{
  if(DALI_LIKELY(Dali::Adaptor::IsAvailable()))
  {
    ...
    if(mReleasePolicy != UI::ImageVisual::ReleasePolicy::NEVER && mSvgRasterizeId != SvgLoader::INVALID_SVG_RASTERIZE_ID)
    {
...
void SvgVisual::DoSetOffScene(Actor& actor)
{
  ...
  if(mReleasePolicy == UI::ImageVisual::ReleasePolicy::DETACHED && mSvgRasterizeId != SvgLoader::INVALID_SVG_RASTERIZE_ID)
  {
