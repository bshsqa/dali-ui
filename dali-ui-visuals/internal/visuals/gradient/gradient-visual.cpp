...
: Visual::Base(factoryCache, Visual::FittingMode::DONT_CARE, UI::Visual::GRADIENT),
  mGradientTransform(Matrix3::IDENTITY),
  mGradient(nullptr),
...
void GradientVisual::OnInitialize()
{
  ...
  mStartOffsetIndex = mImpl->mRenderer.RegisterUniqueProperty(UI::GradientVisual::Property::START_OFFSET, UNIFORM_START_OFFSET_NAME, startOffset);
...
bool GradientVisual::NewGradient(Type gradientType, const Property::Map& propertyMap)
{
  ...
  {
    Property::Value* startPositionValue = propertyMap.Find(UI::GradientVisual::Property::START_POSITION, START_POSITION_NAME);
  ...
  {
    Property::Value* centerValue     = propertyMap.Find(UI::GradientVisual::Property::CENTER, CENTER_NAME);
    Property::Value* startAngleValue = propertyMap.Find(UI::GradientVisual::Property::START_ANGLE, CONIC_START_ANGLE_NAME);
    Vector2          center;
    float            startAngle;
