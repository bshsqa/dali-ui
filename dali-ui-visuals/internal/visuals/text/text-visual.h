...
public:
   ...
   */
  static void SetAnimatableTextColorProperty(Dali::UI::Visual::Base visual, Property::Index animatablePropertyIndex)
  {
   ...
   * @param[in] visual The text visual.
   */
  static void EnableRendererUpdate(Dali::UI::Visual::Base visual)
  {
   ...
   */
  static void SetRequireRender(Dali::UI::Visual::Base visual, bool requireRender)
  {
   ...
   * @param[in] visual The text visual.
   */
  static void UpdateRenderer(Dali::UI::Visual::Base visual)
  {
   ...
   */
  static void SetConstraintApplyAlways(Dali::UI::Visual::Base visual, bool applyAlways, bool notifyToConstraint = false)
  {
...
private:
   ...
   */
  static TextVisual& GetVisualObject(Dali::UI::Visual::Base visual)
  {
    return static_cast<TextVisual&>(Dali::UI::GetImplementation(visual).GetVisualObject());
  };
