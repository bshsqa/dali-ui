...
#include <dali-ui-visuals/internal/visuals/border/border-visual.h>
#include <dali-ui-visuals/internal/visuals/color/color-visual-shader-factory.h>
#include <dali-ui-visuals/internal/visuals/color/color-visual.h>
#include <dali-ui-visuals/internal/visuals/custom-shader-factory.h>
#include <dali-ui-visuals/internal/visuals/gradient/gradient-visual.h>
#include <dali-ui-visuals/internal/visuals/image/image-visual-shader-factory.h>
#include <dali-ui-visuals/internal/visuals/image/image-visual.h>
#include <dali-ui-visuals/internal/visuals/mesh/mesh-visual.h>
#include <dali-ui-visuals/internal/visuals/npatch/npatch-shader-factory.h>
#include <dali-ui-visuals/internal/visuals/npatch/npatch-visual.h>
#include <dali-ui-visuals/internal/visuals/primitive/primitive-visual.h>
...
#include <dali-ui-visuals/internal/visuals/wireframe/wireframe-visual.h>
...
UI::Visual::Base VisualFactory::CreateVisual(const Property::Map& propertyMap, UI::VisualFactory::CreationOptions creationOptions)
{
        ...
        if(imageURLValue->Get(imageUrl))
        {
          if(!imageUrl.empty())
          {
            ...
            switch(visualUrl.GetType())
            {
              ...
              case VisualUrl::WEBP:
              {
                if(visualType == UI::DevelVisual::ANIMATED_IMAGE || !(creationOptions & UI::VisualFactory::CreationOptions::IMAGE_VISUAL_LOAD_STATIC_IMAGES_ONLY))
                {
  ...
  DALI_LOG_INFO(gLogFilter, Debug::Concise, "VisualFactory::CreateVisual( VisualType:%s %s%s)\n", Scripting::GetEnumerationName<UI::DevelVisual::Type>(visualType, VISUAL_TYPE_TABLE, VISUAL_TYPE_TABLE_COUNT), (visualType == UI::DevelVisual::IMAGE) ? "url:" : "", ((visualType == UI::DevelVisual::IMAGE) ? (([&]()
  {
...
UI::Visual::Base VisualFactory::CreateVisual(const std::string& url, ImageDimensions size, UI::VisualFactory::CreationOptions creationOptions)
{
  Visual::BasePtr visualPtr;
