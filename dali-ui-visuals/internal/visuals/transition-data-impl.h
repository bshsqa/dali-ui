...
// INTERNAL INCLUDES
#include <dali-ui-visuals/devel-api/visual-factory/transition-data.h>
...
inline Internal::TransitionData& GetImplementation(Dali::UI::TransitionData& handle)
{
...
inline const Internal::TransitionData& GetImplementation(const Dali::UI::TransitionData& handle)
{
  DALI_ASSERT_ALWAYS(handle && "TransitionData handle is empty");
