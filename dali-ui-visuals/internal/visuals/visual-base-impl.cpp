...
// INTERNAL HEARDER
#include <dali-ui-visuals/public-api/visuals/visual-depth-index-ranges.h>
#include <dali-ui-visuals/devel-api/visuals/color-visual-properties-devel.h>
...
void Visual::Base::SetDepthIndex(int index)
{
  ...
  Dali::ClampInPlace(index, static_cast<int>(UI::DepthIndex::MINIMUM_DEPTH_INDEX), static_cast<int>(UI::DepthIndex::MAXIMUM_DEPTH_INDEX));
