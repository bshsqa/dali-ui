...
enum Type
{
  PLAY = Visual::Action::VISUAL_ACTION_END_INDEX, ///< Play the animated GIF. This is also Default playback mode.
  ...
  ANIMATED_IMAGE_VISUAL_ACTION_END_INDEX = Visual::Action::VISUAL_ACTION_END_INDEX + 1000 ///< End of animated image visual action index.
};
...
#endif // DALI_UI_ANIMATED_IMAGE_VISUAL_ACTIONS_DEVEL_H
