 ...
 *
 * The following properties are optional, but can be supplied in the property map to Dali::UI::VisualFactory::CreateVisual().
 *
 * | %Property Name          | Type             |
 * |-------------------------|------------------|
 * | customShader            | MAP              |
 ...
 * | origin                  | INTEGER or STRING | No       | CENTER                 | origin of the visual @sa Dali::UI::Align       |
 * | anchorPoint             | INTEGER or STRING | No       | CENTER                 | anchor point of the visual @sa Dali::UI::Align |
 * | offsetPolicy            | VECTOR2           | No       | ( RELATIVE, RELATIVE ) | @sa Dali::UI::Visual::Transform::Policy   |
 * | sizePolicy              | VECTOR2           | No       | ( RELATIVE, RELATIVE ) | @sa Dali::UI::Visual::Transform::Policy   |
 *
